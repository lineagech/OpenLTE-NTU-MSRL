...
LTE_fdd_enb_cnfg_db::LTE_fdd_enb_cnfg_db()
{
    ...
    var_map_int64[LTE_FDD_ENB_PARAM_N_RB_DL]                   = LIBLTE_PHY_N_RB_DL_1_4MHZ;
    var_map_int64[LTE_FDD_ENB_PARAM_N_RB_UL]                   = LIBLTE_PHY_N_RB_DL_1_4MHZ;
    var_map_int64[LTE_FDD_ENB_PARAM_DL_BW]                     = LIBLTE_RRC_DL_BANDWIDTH_6;
