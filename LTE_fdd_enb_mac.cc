...
void LTE_fdd_enb_mac::handle_rlc_msg(LTE_FDD_ENB_MESSAGE_STRUCT *msg)
{
       ...
       LTE_FDD_ENB_DEST_LAYER_ANY == msg->dest_layer)
    {
        ...
        msg->msg.dl_schedule.dl_allocations.alloc[0].mcs = 0; ///36.213 table 7.1.7.1-1
        liblte_phy_get_tbs_and_n_prb_for_dl(msg->msg.dl_schedule.dl_allocations.alloc[0].msg.N_bits,
                                                sys_info.N_rb_dl,
                                                msg->msg.dl_schedule.dl_allocations.alloc[0].mcs,
                                                &msg->msg.dl_schedule.dl_allocations.alloc[0].tbs,
                                                &msg->msg.dl_schedule.dl_allocations.alloc[0].N_prb);
        fprintf(stderr, "tbs:%d, N_prb:%d\n", msg->msg.dl_schedule.dl_allocations.alloc[0].tbs, msg->msg.dl_schedule.dl_allocations.alloc[0].N_prb);
        
        msg->msg.dl_schedule.dl_allocations.alloc[0].prb[0][0]=0;
        msg->msg.dl_schedule.dl_allocations.alloc[0].prb[0][1]=1;
        msg->msg.dl_schedule.dl_allocations.alloc[0].prb[0][2]=2;
        msg->msg.dl_schedule.dl_allocations.alloc[0].prb[0][3]=3;
...
void LTE_fdd_enb_mac::handle_sdu_ready(/*LTE_FDD_ENB_MAC_SDU_READY_MSG_STRUCT *sdu_ready*/)
{
    ...
    if(1/*LTE_FDD_ENB_ERROR_NONE == sdu_ready->rb->get_next_mac_sdu(&sdu)*/)
    {
        //user = sdu_ready->user;
        /*
        interface->send_debug_msg(LTE_FDD_ENB_DEBUG_TYPE_INFO,
        ...
        */
        ...
        if(1/*sdu_ready->rb->get_send_con_res_id()*/)
        {
